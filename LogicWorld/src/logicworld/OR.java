...
public class OR extends Gates implements MouseListener, MouseMotionListener {
    ...
    public OR() {
        ...
        try {
            image = ImageIO.read(new File(this.getClass().getResource("orGate.png").getPath()));
    ...
    public void calc(){
        if(giris1value == 1 || giris2value == 1){
            cikisValue = 1;
        }else{
            cikisValue = 0;
        }
